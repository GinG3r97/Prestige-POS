            ...
            child: ListView(
              ...
              children: [
                ...
                _tip(Icons.touch_app_outlined, 'Tap to open',
                    'Tap a Type or Category to view what\'s inside it.'),
                _tip(Icons.edit_outlined, 'Pencil to rename',
                    'Tap the ✎ on a Type/Category to rename it. Tap a product to edit its name and price.'),
                _tip(Icons.add_box_outlined, 'Dashed + to add',
                    'Use the dashed + box to add a new Type, Category, or Product.'),
